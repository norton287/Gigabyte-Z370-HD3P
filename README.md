...
To update to the 10.5.5 beta 2 just boot to clover and press F11 to clear NVRAM.  Then boot into macos and let the System Preference Updater download and start the install.  Reboot and you should see the PreBooter with the Install macOS signature.